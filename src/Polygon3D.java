...
public class Polygon3D {
	...
	public void update() {
		...
		//a rajzot a képernyőn belül kell tartani, kívülre nem rajzolhatunk
	...
	public void draw(BufferedImage FrameBuffer) {
		...
		// a befoglaló téglalap szélessége
		...
		if(imgw>0) { //ha merőlegesen állunk ne rajzoljon
			...
			for(int y=ymin;y<ymax;y++)
			{
				...
				//egy sorban csak a szükséges pixeleket érintjük, nem rajzolunk a képernyőn kívülre
				...
				for(int x=xmin2;x<xmax2;x++)
				{
					...
					//a sor két széléről befele interpoláljuk 1/z,u/z,v/z változókat
					double iz=Util.interpSlope(xmin, x, uvzmin.iz, Siz);
				 	...
				 	// a mögöttünk lévő tárgyak levágását jobban kell megoldani, de a hiba elkerüléséhez ez is elég
				 	if(iz<0) return;
